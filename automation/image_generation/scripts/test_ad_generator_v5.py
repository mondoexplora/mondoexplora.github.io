#!/usr/bin/env python3
"""
Instagram Story Ad Generator v5
Clean version with fixed font parameters and proper hotel box rendering
"""
...
def main():
    print("Creating Instagram Story Ad v5...")
    ...
    filename = f"{output_dir}/instagram_story_v5_{timestamp}.jpg"
    ...
    print(f"✅ Instagram Story ad v5 saved: {filename}")
