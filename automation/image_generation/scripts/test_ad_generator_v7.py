#!/usr/bin/env python3
"""
Instagram Story Ad Generator v7
Version with hotel boxes floating on hero background (no white container)
"""
...
def main():
    print("Creating Instagram Story Ad v7...")
    ...
    filename = f"{output_dir}/instagram_story_v7_{timestamp}.jpg"
    ...
    print(f"✅ Instagram Story ad v7 saved: {filename}")
